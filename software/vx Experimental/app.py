...
lcd.setRGB(255, 255, 70)
lcd.print_line1(f"PTZ camera")
lcd.print_line2(f"(with mixer)")
...
desk_volume = VolumeControl(slider, mixer, 9, invert=True) # This one is wired backwards :(
aux_volume = VolumeControl(dial, mixer, 10)
